      ...
      <td width="753" height="250" align="left" bgcolor="#FFFFFF"><div align="center">EDIT REKOMENDASI WISATA
        </div>
        <table width="755" border="0">
          ...
          <tr>
            <td>&nbsp;</td>
            <td><p align="left">        
                <form enctype="multipart/form-data" method="post" action="?page=update_rekomendasi&id=<?php echo $_GET['id'] ?>">
                  <table width="701" border="0">
                    <?php

$id = $_GET['id'];
$edit		= "select * from tbl_rekomendasi where id_rekomendasi=$id";
