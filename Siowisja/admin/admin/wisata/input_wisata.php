      ...
      <td width="753" height="250" align="left" bgcolor="#FFFFFF"><div align="center">INPUT  WISATA
        </div>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><p align="left"><form action="?page=proses_wisata" method="post" enctype="multipart/form-data">
